    ...
    <section className="w-full bg-white py-12 px-4 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="mt-4 md:mt-6 text-sm md:text-base text-gray-500 leading-relaxed">
              To ensure accurate, reliable, and standardized environmental data,
              our Automated Rain Gauge (ARG) solutions are designed in full
              alignment with the World Meteorological Organization (WMO)
              specifications.
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col sm:flex-row md:flex-row lg:flex-col xl:flex-row gap-6 md:gap-8 text-sm md:text-base text-gray-600 mt-4  lg:mt-46">
            <RightFeature
              title="High Measurement Accuracy"
              text="WMO-compliant design ensures precise rainfall data."
            />
            <RightFeature
              title="Calibration & Alerts"
              text="Automatic calibration reminders and alerts maintain accuracy."
            />
          </div>
        </div>
        ...
        <div className="mt-10 md:mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-10 text-sm md:text-base text-gray-600">
          <RightFeature
            title="Field Deployment Standards"
            text="Robust design for harsh or remote deployment sites."
          />
          <RightFeature
            title="Data Validation"
            text="Automated validation checks ensure trusted results."
          />
          <RightFeature
            title="Sensor Traceability"
            text="NIST-traceable calibration supports long-term comparability."
          />
        </div>
...
const RightFeature = ({ title, text }) => (
  <div className="flex items-start max-w-sm mx-auto sm:mx-0">
    ...
    <div>
      <h4 className="font-medium text-gray-800 text-sm md:text-lg">
        {title}
      </h4>
