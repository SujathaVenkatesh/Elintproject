...
const Hero = () => {
  const imageUrl = "/cargotracking.webp";
  ...
  return (
    <section className="w-full bg-white pt-10 md:pt-14">
      ...
      >
        {/* SOFT LEFT WHITE FADE — IMAGE REMAINS CLEAR */}
        <div className="absolute inset-0 bg-gradient-to-r from-white via-white/0 to-transparent" />

        {/* CONTENT */}
        <div className="relative z-10 w-full px-4 sm:px-8 md:px-12 lg:px-28 py-10 md:py-0">
          <div className="max-w-full sm:max-w-[500px] md:max-w-[620px]">
            
            {/* TITLE */}
            <h1
              className="
                text-[20px] sm:text-[22px] md:text-[22px] lg:text-[26px]
                font-normal leading-snug text-gray-900 font-[Manrope]
              "
            >
              Cargo Tracking That Ends Delays, Disputes, and Disruption
            </h1>
            ...
            <p
              ...
              "
            >
              Powered by Hybrid Satellite + LTE Connectivity for Unbroken Visibility
            </p>
