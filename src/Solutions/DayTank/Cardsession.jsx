...
const solutions = [
    ...
    {
        image: 'fs2.jpeg', // Placeholder for /fs2.jpeg
    ...
    {
        image: 'fs3.jpeg', // Placeholder for /fs3.jpeg
    ...
    {
        image: 'fs4.jpeg', // Placeholder for /fs4.jpeg
...
const SolutionCard = ({ solution }) => {
    ...
    return (
        <div className="group flex flex-col h-full items-center text-center">
            {/* Image Card (Hover effects for lift and shadow) */}
            <div
                className="rounded-3xl bg-white shadow-sm border border-gray-100
                            flex items-center justify-center h-64 w-full mb-5 p-4
                            transition-all duration-300 group-hover:shadow-xl group-hover:-translate-y-1"
            >
                {/* NOTE: Using placeholder images for now. Replace with actual asset paths. */}
                <img
                    src={image}
                    alt={alt}
            ...
            {/* Pill Tag + Arrow (Centered for mobile, adapting width) */}
            <button
                type="button"
                className="inline-flex items-center justify-between rounded-full bg-gray-100/80 px-5 py-2 mb-3
                            text-[12px] font-medium text-gray-700 w-full max-w-[250px]
            ...
            {/* Text Block (Aligned left within card, centered overall) */}
            <div className="text-center mt-1 space-y-2 w-full max-w-[250px]">
