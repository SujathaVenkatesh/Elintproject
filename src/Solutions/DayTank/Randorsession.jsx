      ...
      <div className="px-5 
        ...
        <div className="hidden md:flex flex-col items-center">
          <div className="flex items-center justify-center">
            {/* LEFT arc */}
            <div className="relative w-[25vw] left-[3vw] h-[360px]">
              <ArcCircle
                side="left"
                position="top"
                icon={<img src="/rs1.png" className="w-6 h-6 object-contain" />}
                label={<>Measurement Range: 20mm to<br /> 20meters</>}
              ...
              <ArcCircle
                ...
                label={<>Accuracy : 0.5% FSR from 150mm <br /> to 20 meters</>}
                cust_class="flex-row-reverse"
              />
              <ArcCircle
                side="left"
            ...
            <div className="rounded-3xl bg-white py-10 flex items-center justify-center">
              <Image
                src="/daytank8.png"
            ...
            {/* RIGHT arc */}
            <div className="relative w-[25vw] left-[-6vw] h-[360px]">
              <ArcCircle
                side="right"
                position="top"
                icon={<img src="/rs4.png" className="w-6 h-6 object-contain" />}
                label={<>Wireless Connectivity:<br /> BLE 5.2</>}
              />
              <ArcCircle
                side="right"
                position="middle"
...
function ArcCircle({ side, position, icon, label, cust_class }) {
  const base = "absolute flex gap-3 items-center text-[13px] text-gray-600 max-w-[420px]";
  let posClasses = "";
  ...
  return (
    <div className={`${base} ${dirClass} ${posClasses} ${cust_class} `}>
      ...
      <p className={`${side == "left" ? "text-right" : ""} leading-snug text-[13px]
                ...
                font-normal f1 text-[#494949] whitespace-normal md:whitespace-nowrap lg:whitespace-nowrap max-w-[240px] sm:max-w-[280px] md:max-w-[360px] lg:max-w-[400px]`}>{label}</p>
    </div>
  );
}
