  ...
  return (
    <section className="w-full bg-white font-['Manrope']">
      ...
      >
        ...
        {/* OVERLAY */}
        <div className="absolute inset-0 bg-gradient-to-r from-white/100 via-white/100 to-transparent"></div>
        ...
        >
          ...
          >
            ...
            <h1
              ...
              "
            >
              Still Guessing Your Fuel Levels? <br />
              Optimize Every Drop with Our Fuel Level Monitoring System
            </h1>
