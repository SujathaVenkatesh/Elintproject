...
const ChaosSection = () => {
  ...
  return (
    <section className="relative w-full py-16 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      ...
      {/* Water Background – Bottom Only */}
      <div
        className="absolute bottom-0 left-0 w-full h-40 bg-cover bg-bottom opacity-60"
        style={{
          backgroundImage:
            'url("https://res.cloudinary.com/dt3k5v4wz/image/upload/v1718017260/water-splash_d3a3w6.png")',
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 lg:px-10">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 sm:p-10 md:p-14 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            {/* Column Left */}
            <div>
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-6 border-b-2 border-blue-500 pb-2 inline-block">
                Tank Inefficiencies
              </h3>

              <FeatureItem icon={icons.manual} title="Manual Operation Dependency"
                description="Pumps are often not turned ON/OFF at the right time, leading to inconsistent filling." />

              <FeatureItem icon={icons.overflow} title="Overflow Wastage"
                description="No auto cut-off causes frequent overflows, wasting water and energy." />

              <FeatureItem icon={icons.alerts} title="Zero Predictive Alerts"
                description="No notifications for low/high levels until it’s too late – reactive, not proactive." />

              <FeatureItem icon={icons.airlocks} title="Airlocks & Pressure Drops"
            ...
            <div>
              ...
              <FeatureItem icon={icons.voltage} title="Voltage Fluctuation Risks"
                description="Unstable power supply leads to frequent motor stress and damage." />

              <FeatureItem icon={icons.dryRun} title="Dry Run & Overload Failures"
                description="Running pumps without adequate water or pressure can cause burnout." />

              <FeatureItem icon={icons.noFault} title="No Fault Memory"
                description="Without error logging, recurring issues remain unnoticed and unresolved." />

              <FeatureItem icon={icons.noRuntime} title="No Runtime Optimization"
                description="Manual operation wastes power and reduces pump lifespan." />
            </div>
