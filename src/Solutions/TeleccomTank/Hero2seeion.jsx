      ...
      >
        ...
        <div className="relative w-full px-5 sm:px-8 md:px-20 py-6">
          <p
            ...
            "
          >
            Most failures don’t begin at the grid—they begin with the batteries
            meant to protect you from it. Degradation happens silently, and by
            the time it’s visible, it’s often too late. Our system eliminates the
            blind spots, turning hidden battery vulnerabilities into clear,
            actionable insights. So when the power goes out, your backup power
            doesn’t.
          </p>
        </div>
      </div>
