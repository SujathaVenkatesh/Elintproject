...
export default function HeroSection() {
  ...
  // 🧭 Start auto-rotation and initial animation
  useEffect(() => {
  ...
  // 🔄 Auto-rotate to the next banner
  useEffect(() => {
  ...
  // The handleDotClick function is defined in the original code, but not used.
  ...
  return (
    <>
      <section className="relative w-[100%] h-[140vh] md:h-[90vh] overflow-hidden flex items-center justify-center">
        ...
        {/* 💻 2️⃣ Desktop Banner Images (Hidden on Mobile) */}
        ...
        {/* 💻 3️⃣ Desktop Content Overlay (Hidden on Mobile) */}
        <div className="absolute inset-0 hidden md:flex items-center mt-24 justify-center z-20">
          {banners.map((banner, i) => (
            ...
            >
              ...
              {/* Desktop Floating Buttons (Banner 1 and 3 only) */}
          ...
          {banners.map((banner, i) => (
            ...
            >
              ...
              <div className="relative w-full h-[330px] mt-4">
                {/* Background Gradient Overlay - Note: Only for Banner 2 (i=1) in the original code */}
                {i === 1 && (
                ...
                {/* Floating Product Buttons - Mobile Positioning (Banner 1 only) */}
                {banner.id === 1 && (
                  <>
                ...
                {/* Floating Product Buttons - Mobile Positioning (Banner 3 only) */}
                {banner.id === 3 && (
                  <>
                    {/* Three Phase Smart Starter - Left Edge */}
          ...
          <div className="absolute bottom-28 left-0 right-0">
            ...
            <div className="flex items-center justify-between px-22 mt-[-20]">
              <button
                ...
                style={{
                  background:
                    "radial-gradient(36.17% 36.17% at 51.06% 51.06%, rgba(227, 223, 223, 0) 0%, rgba(218, 214, 214, 0.2) 100%)",
                }}
              >
